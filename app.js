(() => {
  ...
  function judgeRiders(event) { return event.riders.filter(rider => permittedCategoryIds(event).has(rider.categoryId) && rider.categoryId === state.judgeState.categoryId && rider.status === 'checked-in'); }
